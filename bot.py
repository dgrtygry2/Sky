...
def chatbot():
    print("Hello! I'm Sky! I'm an artificial intelligernce! Chat with me!")
    memory = load_data()
    user_facts = {}
    ...
    while True:
        ...
        bot_response = generate_response(user_input, memory, user_facts)
        ...
        # Log the bot's diary entry (thoughts after the conversation)
